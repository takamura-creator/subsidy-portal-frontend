...
const FAQ_ITEMS = [
  { q: "補助金診断は本当に無料ですか？", a: "はい、完全無料です。業種・従業員数・都道府県を入力するだけで、条件に合う補助金を自動マッチングします。診断後の申請書作成まで無料でご利用いただけます。" },
  { q: "どの補助金が使えるか分からないのですが？", a: "ご安心ください。全国の補助金データベースから条件に合う補助金をご提案します。IT導入補助金、ものづくり補助金、各自治体の独自補助金など幅広く対応しています。" },
